...
#Remove anything that doen't have horizon level data! OR! Keep if you're just interested in mapping the HPU
...
sf::st_write(XY, "data/HorizonThickness_all.shp", delete_layer=TRUE)
